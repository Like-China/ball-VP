...
public class Main{
    ...
    {   
        ...
        String setInfo = String.format("Data: %s \tqSize: %d \tdbSize: %d \tdim: %d \tleafSize: %d \tsample: %d", data, query.size(), db.size(), dim, leafSize, sample);
    ...
    public void evaluate_multi()
    {
        ...
        int[] dbSizes = new int[]{10000, 20000, 20000, 40000, 50000};
        ...
        System.out.println("Round 1 time cost: "+(System.currentTimeMillis()-t1));
        ...
        System.out.println("Round 2 time cost: "+(System.currentTimeMillis()-t1));
        for(int dim: dims)
        {
        ...
        System.out.println("Round 3 time cost: "+(System.currentTimeMillis()-t1));
        ...
        System.out.println("Round 4 time cost: "+(System.currentTimeMillis()-t1));
        ...
        System.out.println("Round 5 time cost: "+(System.currentTimeMillis()-t1));
    ...
    public static void main(String[] args) {
        ...
        // new Main().evaluate_one(Settings.data, Settings.qNB, Settings.dbNB, Settings.dim, Settings.minLeafNB, Settings.sampleNB);
    }
}